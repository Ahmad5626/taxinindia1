class Magnetic {
    constructor(el, options = {}) { this.el = jQuery(el); this.options = jQuery.extend(!0, { y: 0.3, x: 0.3, s: 0.2, rs: 0.7 }, this.el.data('magnetic') || options); this.y = 0; this.x = 0; this.width = 0; this.height = 0; if (this.el.data('magnetic-init')) return; this.el.data('magnetic-init', !0); this.bind() }
